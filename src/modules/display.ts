...
const bookInfoContainer: Element = document.querySelector('#book-info');
const bookInfoCover: Element = document.querySelector('#book-info-cover');
const bookInfoTitle: Element = document.querySelector('#book-title');
const bookInfoAuthor: Element = document.querySelector('#book-author');
const bookInfoPlot: Element = document.querySelector('#book-plot');
const bookInfoAudience: Element = document.querySelector('#book-audience');
const bookInfoPublished: Element = document.querySelector('#book-first_published');
const bookInfopages: Element = document.querySelector('#book-pages');
const bookInfoPublisher: Element = document.querySelector('#book-publisher');
...
let currentDisplayedBooks: Books[] = [];
...
function displayBookInfo(bookId: string) {
    pageTitle.style.zIndex = '20';
    const book: any = currentDisplayedBooks.filter((book) => book.id === Number(bookId));
...
function displayBooks(books: Books[], searchQuery: string | null) {
...
function displayBook(book: any, contiainer: Element) {
...
function displayBookText(book: any) {
